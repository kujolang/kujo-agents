...
Current release metadata: `v1.4.0`; the tagged `v1.0.0` Chain of Command baseline remains preserved.

Public scope: independent reusable Chain of Command, WebOps, Publishing House,
and VideoOps agent contracts, their shared maps, and evidence and authority boundaries.
...
- [x] VideoOps names shared media execution, scoped authority, audio QA, and
  exact-candidate/human review without claiming role templates enforce them.
...
- [x] Public use and adaptation instructions were reviewed for the `v1.4.0`
  baseline.
...
- Release metadata: `VERSION`, README badge, changelog, and intended release
  name use `1.4.0` / `v1.4.0` consistently; no tag is created by this change.
