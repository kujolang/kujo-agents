...
Current release metadata: `v1.3.0`; the tagged `v1.0.0` Chain of Command baseline remains preserved.
...
- [x] Public use and adaptation instructions were reviewed for the `v1.3.0`
  baseline.
...
- Release metadata: `VERSION`, README badge, changelog, and intended release
  name use `1.3.0` / `v1.3.0` consistently; no tag is created by this change.
